...
public class FanoutRabbitMQConfig {
	...
	public Queue queueFanout01() {
		return new Queue(IRabbitMQConstants.QUEUE_NAME_FANOUT01);
	}
	@Bean(name="queueFanout02")
	public Queue queueFanout02() {
		return new Queue(IRabbitMQConstants.QUEUE_NAME_FANOUT02);
	}
	@Bean(name="queueFanout03")
	public Queue queueFanout03() {
		return new Queue(IRabbitMQConstants.QUEUE_NAME_FANOUT03);
	}
	
	/* fanout exchange */
	@Bean
	public FanoutExchange fanoutExchange() {
		FanoutExchange exchange = new FanoutExchange(IRabbitMQConstants.EXCHANGE_FANOUT);
		return exchange;
	}
